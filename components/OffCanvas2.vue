<template>
   <div id="offcanvas-nav"class="uk-off-canvas" data-uk-offcanvas="flip: true; overlay: true">
                        ...
                        <ul class="uk-nav-sub">
                            ...
                            <nav class="tm-navbar uk-navbar uk-navbar-attached uk-navbar-transparent">
                                <div class="uk-container uk-container-center">
                                    ...
                                    <a class="uk-navbar-brand uk-hidden-small" href="index.html"><img class="uk-margin uk-margin-remove" src="logo.svg" width="90" height="30" title="UIkit" alt="UIkit"></a>
                                    ...
                                    <div class="uk-navbar-brand uk-navbar-center uk-visible-small"><img src="logo.svg" width="90" height="30" title="UIkit" alt="UIkit"></div>
                    
                                </div>
                            </nav>             <li><a href="docs/documentation_custom-prefix.html">Custom prefix</a></li>
                        </ul>
                    </li>
